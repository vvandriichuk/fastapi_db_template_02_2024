...
def custom_revision_filename_template(rev, context):
    date_format = datetime.now().strftime("%Y_%m_%d_%H_%M_%S")
    return f"{rev}_{context.get('message', '').replace(' ', '_')}_{date_format}"
...
def run_migrations_offline() -> None:
    ...
    context.configure(
        ...
        revision_filename_template=custom_revision_filename_template,
